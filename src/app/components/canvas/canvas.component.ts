...
export class CanvasComponent implements OnInit, OnDestroy {
  ...
  initMovingPostListener() {
    ...
    this.canvas.on('mouse:down', handlePostClicked);
    this.canvas.on('object:moved', handlePostMoved);

    return () => {
      this.canvas.off('mouse:down', handlePostClicked);
      this.canvas.off('object:moved', handlePostMoved);
    }
  }
